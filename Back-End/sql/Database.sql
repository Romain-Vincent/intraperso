/*
** Database.sql: File containing the definition of all the tables of the database.
**
*/
...
CREATE INDEX `SOP_P_UNIQUE` ON `Projects`.`StudentsOfProject` (`P_ID` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `Projects`.`StatusPoints` (
  `SP_P_ID` INT NOT NULL,
  `SP_Date` DATE NOT NULL ,
  `SP_Text` LONGTEXT NOT NULL ,
  PRIMARY KEY (`SP_P_ID`, `SP_Date`))
ENGINE = InnoDB;
